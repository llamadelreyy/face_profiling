...
const VehicleScanner = () => {
  const [statusMessage, setStatusMessage] = useState('Vehicle scanner system monitoring entry points.');
  ...
  const clearResults = () => {
    ...
    setStatusMessage('Vehicle scanner system monitoring entry points.');
  ...
  const updateStationDisplay = (station) => {
    if (station === '01' || station === 'ALL') {
      setStatusMessage('Vehicle Scanner Station - Ready to capture image.');
    } else {
    ...
    <>
      ...
      <div className="test-container">
        ...
        <div className="test-main-content-layout">
          ...
          {/* Main Display - Vehicle Scanner Results */}
