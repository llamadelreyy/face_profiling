...
const TerminalSecurity = () => {
  const [statusMessage, setStatusMessage] = useState('Terminal security monitoring all areas.');
  ...
  const clearResults = () => {
    ...
    setStatusMessage('Terminal security monitoring all areas.');
  ...
  const updateStationDisplay = (station) => {
    if (station === '01' || station === 'ALL') {
      setStatusMessage('Terminal Security Station - Ready to capture image.');
    } else {
  ...
  return (
    <>
      ...
      <div className="test-container">
        {/* Header */}
        <Header title="Terminal Security System" />
        ...
        <div className="test-main-content-layout">
          ...
          {/* Main Display - Terminal Security Results */}
