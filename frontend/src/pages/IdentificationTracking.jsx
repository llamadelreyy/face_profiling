...
const IdentificationTracking = () => {
  const [statusMessage, setStatusMessage] = useState('Identification tracking system operational.');
  ...
  const clearResults = () => {
    ...
    setStatusMessage('Identification tracking system operational.');
  ...
  const updateStationDisplay = (station) => {
    if (station === '01' || station === 'ALL') {
      setStatusMessage('Identification Tracking Station - Ready to capture image.');
    } else {
    ...
    <>
      ...
      <div className="test-container">
        ...
        <div className="test-main-content-layout">
          ...
          {/* Main Display - Identification Tracking Results */}
