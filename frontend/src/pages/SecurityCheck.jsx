...
const SecurityCheck = () => {
  const [statusMessage, setStatusMessage] = useState('Security checkpoint monitoring active.');
  ...
  const clearResults = () => {
    ...
    setStatusMessage('Security checkpoint monitoring active.');
  ...
  const updateStationDisplay = (station) => {
    if (station === '01' || station === 'ALL') {
      setStatusMessage('Security Check Station - Ready to capture image.');
    } else {
  ...
  return (
    <>
      ...
      <div className="test-container">
        {/* Header */}
        <Header title="Security Check System" />
        ...
        <div className="test-main-content-layout">
          ...
          {/* Main Display - Security Check Results */}
